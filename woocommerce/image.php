...
define("DEFAULT_FONT", "font/myfont.ttf");
...
$fit = $_GET['fit'] ? $_GET['fit'] : 0;

$text_dimensions = calculateTextDimensions($text, $font, $size, $angle, $spacing);

if($fit==1){
if($text_dimensions["width"]>1020){
while($text_dimensions["width"]>1020){
...
function imagettftextSp($image, $size, $angle, $x, $y, $color, $font, $text, $spacing = 0)
{
	...
	$fontwidth = ImageFontWidth($font);
     ...
     $maxcharsperline = floor($x / $fontwidth);
